        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fa-duotone fa-store text-light "></i>
                </div>
                <div class="sidebar-brand text-light  mx-3">TB Elva</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/elektronik') ?>">
                    <i class="fa-light fa-boot"></i>
                    <span class="text-light ">Barang Elektronik</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/perlengkapan_rumah_tangga') ?>">
                    <i class="fa-solid fa-boot-heeled"></i>
                    <span class="text-light ">Perlengkapan Rumah Tangga</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/perlengkapan_dapur') ?>">
                    <i class="fa-solid fa-boot-heeled"></i>
                    <span class="text-light ">Perlengkapan Dapur</span></a>
            </li>
